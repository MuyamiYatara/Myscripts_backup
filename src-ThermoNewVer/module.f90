  ...
  module para
     ...
     logical :: thermag_calc ! calculate thermomagnetic coefficient
     ...
     namelist / Control / BulkBand_calc, BulkFS_calc,  BulkFS_Plane_calc, &
                          ...
                          valley_projection_calc, Matrix_Element_calc, BdGChern_calc, SlabBdG_calc,thermag_calc
     ...
     real(dp) :: m1x, m1y, m1z, m2x, m2y, m2z
     ...
     real(dp),parameter :: Hartree_SI= 4.35974452258E-18 ! Hartree to Joule
