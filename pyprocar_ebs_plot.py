...
class EBSPlot:
    ...
    def set_xticks(self, 
        ...
        if self.kpath is not None:
            ...
            for ipos in tick_positions:
                self.ax.axvline(self.x[ipos], color=color, linewidth=1, alpha=0.1)
    ...
    def set_xlabel(self, label:str=" "):
        ...
        """
        self.ax.set_xlabel(label, fontsize=16, labelpad=15)

    def set_ylabel(self, label:str=r"Energy (eV)"):
    ...
    def set_title(self, title:str="Band Structure"):
        ...
        """
        self.ax.spines['top'].set_linewidth(1.5)    # 上边框粗细
